...
<?php 
	...
	$rol = $_POST['count1'];
	$query = "update students set price = price + '$pp' where roll_no = '$rol' and mess = 'Mega Mess'";
	$result = mysqli_query($db,$query);

	 if($result){
	 	$queryw = "select count(*) as c from students where roll_no = '$rol' and mess = '1st Block'";
...
<div style="background: #cc99ff; margin: 20px;"> 
  <form method="post" action="mess4.php" style="margin: 60px;">
