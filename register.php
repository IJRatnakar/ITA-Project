    ...
    <form method="post" action="register.php" id="Login">
      <?php include('login_errors.php'); ?>
         ...
         <div class="form-group">
            ...
            <input type="text"  name="rollno" class="form-control" id="inputEmail" placeholder="Roll No">
        ...
        <div class="form-group">
            ...
            <input type="password"  name="password_2" class="form-control" id="inputPassword" placeholder="Confirm Password">
